...
<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<img alt="" src="img/doct.png" height="380px">
			</div>
	...
	<div class="container p-2">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doct1.jfif" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doct2.png" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doct3.png" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/doct4.jfif" width="250px" height="300px">
